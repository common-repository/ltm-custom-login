...
= 1.1.0 =
There was a script error on the registration of scripts that could cause problems on the dashboard.

= 1.2.0 =
It was difficult to see the links depending on what background you selected, so I added functionality to change the link color and hover colors also.

= 1.3.0 =
There was an issue with the css on the login page, the margin offset didn't center the image, that is fixed now.
